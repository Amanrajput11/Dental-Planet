    ...
    <div className="container py-5" style={{ maxWidth: 1100 }}>
      ...
      <div className="row g-5 align-items-center mb-5">
        ...
        <div className="col-12 col-lg-8">
          <h1 className="fw-bold mb-1">Dr. Khushboo Barjatya Vatsal</h1>
      ...
      <section className="bg-light rounded-4 p-4 p-md-5 mb-5">
        <h3 className="fw-bold text-center mb-4">Pediatric Dental Services</h3>
        ...
        <div className="row g-4">
          <div className="col-md-6">
            <div className="bg-white shadow rounded-4 p-4 h-100">
              <h5 className="fw-semibold mb-3">Clinic Timings</h5>
              <ul className="lh-lg mb-0">
                <li>Weekdays: 10:00 AM – 2:00 PM</li>
                <li>Evening: 5:00 PM – 8:30 PM</li>
                <li>Sunday: Appointment Only (10:00 AM – 12:00 PM)</li>
              </ul>
            </div>
          </div>
          ...
          <div className="col-md-6">
            <div className="bg-white shadow rounded-4 p-4 h-100">
              <h5 className="fw-semibold mb-3">Clinic Address</h5>
              <p className="mb-1">
